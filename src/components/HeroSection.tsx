  ...
  return (
    <section className="min-h-screen flex flex-col justify-center items-center relative px-6 overflow-hidden pb-12">
      ...
      >
        ...
        >
          <div className="glitch-text" data-text="Prathmesh">
            Prathmesh
          </div>
          <br />
          <div className="glitch-text" data-text="Dawkar.">
            <span className="text-foreground/20">Dawkar.</span>
          </div>
        </motion.h1>
        ...
        <motion.div variants={itemVariants} className="mt-10">
          <Magnetic strength={0.1}>
            <a
              href="/images/Prathmesh_Dawkar_Resume__New.pdf"
              download="Prathmesh_Dawkar_Resume.pdf"
              onClick={playClick}
